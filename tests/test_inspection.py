...
class TestInspectModel:
    def test_returns_columns_and_relationships(self):
        from fastapi_console.inspection import inspect_model
...
class TestIsAbstract:
    def test_abstract_model(self):
        from fastapi_console.inspection import is_abstract
...
class TestGetPkField:
    def test_single_primary_key(self):
        from fastapi_console.inspection import get_pk_field
...
class TestIsRequired:
    def test_required_column(self):
        from fastapi_console.inspection import inspect_model, is_required
